...
<header class="fixed">
	<div class="inner-wrap">
		<h1 class="sr-only">상담예약조회</h1>
		<h2 class="page-title" id="pa2">상담예약조회</h2>
		<!-- back버튼 노출시 -->
...
<body>
    ...
    function nextYes(){		
		...
		*/
		$("#nextPage").attr("action", ctx + "/SEU900110M.do");
		$("#nextPage").submit();
    }
    
    function nextContent(){		
		$("#nextPage").attr("action", ctx + "/csut_view.do");
    }
	function appTitleCallBack(){
		setBackBtn('02', '');
	}
...
<input type="hidden" id="yesUrl" name="yesUrl" value="kiwicustomer/csut_view.do" />
	<input type="hidden" class="wFull" id="v_Name" name="Name" value="" />
	<input type="hidden" class="wFull" id="v_Jumin1" name="custJumin1" value="" />
	<input type="hidden" class="wFull" id="v_Jumin2" name="custJumin2" value="" />
	<input type="hidden" class="wFull" id="v_Jumin" name="Jumin" value="" />
	<input type="hidden" class="wFull" id="noUrl" name="noUrl" value="#" />	
	<input type="hidden" id="etcValue1" 	name="etcValue1"   value="SAV600030M.do" />
	<input type="hidden" class="wFull" id="etcValue2" name="etcValue2" />
	<input type="hidden" class="wFull" id="etcValue3" name="etcValue3"  />
	<input type="hidden" id="ALERT_NO" name="ALERT_NO"  />
	<input type="hidden" id="ALERT_YES" name="ALERT_YES"  />
	<input type="hidden" id="ALERT_TITLE" name="ALERT_TITLE"  />
	<input type="hidden" id="ALERT_CONTS" name="ALERT_CONTS"  />
	<input type="hidden" id="BANNER_CODE" name="BANNER_CODE" value="7401"  />
	<input type="hidden" id="backwardUrl" name="backwardUrl" value="nonlogin"  />				
</form>
<form	id="ajaxJumin"	name="ajaxJumin"	method="POST">
