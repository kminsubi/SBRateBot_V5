...
<header class="fixed">
	<div class="inner-wrap">
		<h1 class="sr-only">수수료안내</h1>
		<h2 class="page-title" id="pa2">수수료안내</h2>
		<!-- back버튼 노출시 -->
			...
			<div id="contents">
				<section class="pd-h">
					<div class="ui-tab">
						...
						<!-- 내부페이지 이동형일때 container 안에 contents -->
						<div class="tab-container mt10">
							<div class="tab-contents active">
								<!-- hx 태그 순서에 맞게 수정 표시할 제목이 없는 경우 -->
								<h3 class="sr-only">이체</h3>
								<table class="data-table">
									<caption>이체 정보</caption>
									<colgroup>
										<col>
									...
									<tbody>
										<tr>
											<th scope="row">당행이체</th>
											<td class="align-center">없음</td>
										</tr>
										<tr>
											<th scope="row">타행이체</th>
											<td class="align-center">없음</td>
										</tr>
									</tbody>
								</table>
							...
							<div class="tab-contents">
								<!-- hx 태그 순서에 맞게 수정 표시할 제목이 없는 경우 -->
								<h3 class="sr-only">자동화기기</h3>
								<table class="data-table">
									<caption>자동화기기 정보</caption>
									<colgroup>
										<col style="width:20%">
										<col style="width:30%">
										<col style="width:25%">
									...
									<thead>
										<tr>
											...
											<th scope="col">영업시간내</th>
											<th scope="col">영업시간외</th>
										</tr>
									</thead>
									<tbody>
										<tr>
											<th scope="row" colspan="2">출금</th>
											<td class="align-center">700원</td>
											<td class="align-center">1,000원</td>
										</tr>
										<tr>
											<th scope="row" colspan="2">당행이체</th>
											<td class="align-center">700원</td>
											<td class="align-center">1,000원</td>
										</tr>
										<tr>
											<th scope="row" rowspan="2">타행<br>이체</th>
											<th scope="row">10만원 이하</th>
											<td class="align-center">500원</td>
											<td class="align-center">1,000원</td>
										</tr>
										<tr>
											<th scope="row">10만원 초과</th>
											<td class="align-center">1,000원</td>
											<td class="align-center">1,500원</td>
										</tr>
									</tbody>
								</table>
								<ul class="list-bullet-cir mt10">
									<li><em>타행 CD/ATM 이용시 발생되는 수수료이며, 영업시간은 자동화기기 은행 기준에 따릅니다.</em></li>
									<li>kiwi입출금통장으로 현금카드 이용 시 출금수수료가 월 5회 면제됩니다.</li>
								</ul>
							</div>
						</div>
					</div>
