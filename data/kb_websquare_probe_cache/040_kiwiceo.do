...
<header class="fixed">
	<div class="inner-wrap">
		<h1 class="sr-only">CEO인사말</h1>
		<h2 class="page-title" id="pa2">CEO인사말</h2>
		<!-- back버튼 노출시 -->
...
<body>
	...
	<!-- SR-260129-00414 당사 모바일 웹 이용안내 > 은행 안내 > CEO 인사말 UI 변경 -->
	<style>
		*{padding:0;margin:0}
		.ceo-wrap .ceo-wrap-box{padding:25px 21px}
		.ceo-wrap .ceo-wrap-box .photo{border-radius:12px;box-shadow:0 0 2px 0 rgba(20,20,20,0.08), 0 16px 24px 0 rgba(20,20,20,0.16);overflow:hidden;background:transparent;width:100%;height:auto;line-height:0;vertical-align:top}
		.ceo-wrap .ceo-wrap-box .photo img{width:100%;line-height:0}
		.ceo-wrap .ceo-wrap-box .txt-wrap{margin-top:25px}
		.ceo-wrap .ceo-wrap-box .txt-wrap .txt1{font-size:20px;font-weight:600;color:#373737;line-height:30px;letter-spacing:-0.4px;margin-bottom:25px}
		.ceo-wrap .ceo-wrap-box .txt-wrap p + p{margin-top:15px}
		.ceo-wrap .ceo-wrap-box .txt-wrap p{font-size:14px;color:#373737;font-weight:400;line-height:22px;letter-spacing:-0.28px}
		.ceo-wrap .ceo-wrap-box .txt-wrap ul{list-style:none;margin:25px 0}
		.ceo-wrap .ceo-wrap-box .txt-wrap ul li{display:flex;color:#373737;font-size:14px;font-weight: 600;line-height:22px;letter-spacing:-0.28px}
		.ceo-wrap .ceo-wrap-box .txt-wrap ul li .num_ceo{display:block;width:68px}
		.ceo-wrap .ceo-wrap-box .txt-wrap ul li .txt {width:calc(100% - 68px)}
		.ceo-wrap .ceo-wrap-box .txt-wrap ul li + li {margin-top:15px}
		.ceo-wrap .ceo-wrap-box .sign {margin-top:25px;font-size:14px;font-weight:600;line-height:30px;letter-spacing:-0.28px;color:#373737;}
		.ceo-wrap .ceo-wrap-box .sign span{display:block;font-size:20px;font-weight:600;letter-spacing:-0.4px;}
	</style>
	<!-- SR-260129-00414 당사 모바일 웹 이용안내 > 은행 안내 > CEO 인사말 UI 변경 -->
	...
	<div class="wrapper" id="wrapper">
		...
		<div id="container">
			<div id="contents">
				...
				<div class="ceo-wrap">
					<div class="ceo-wrap-box">
						<!-- SR-260519-01905 [모바일Web] KB저축은행 모바일 및 PC 화면 네이밍 변경 요청 - 이미지 변경 (ceo_img.png -> ceo_img.jpg) -->
						<div class="photo"><img src="/mobweb/images_kiwi/ncontents/ceo_img.jpg" alt="KB저축은행 대표이사 곽산업"></div>
						<div class="txt-wrap">
							<p class="txt1">안녕하십니까?<br> KB저축은행 대표이사 곽산업입니다.</p>
							<p>항상 KB저축은행에 사랑과 신뢰를 보내주시는<br> 고객님들께 깊은 감사의 말씀을 드립니다.</p>
							<p>KB저축은행은 서민, 중소기업에 대한 금융 지원을 통해 지역사회와 더불어 함께 성장하고  사회적 책임을 다하기 위해 전 임직원이 최선을 다하고 있습니다.</p><br>
							<p>이를 위해, 우리 회사는 고객의 신뢰를 기업의 가장 중요한 자산이자, 지속가능한 성장의 출발점으로 보고 있습니다. 이에, 금융기관으로서, 금융소비자보호와 정보보호, 그리고 건전한 내부통제 체계를 경영의 핵심 원칙으로 삼고 있습니다.</p><br>
							<p>우리는 이러한 원칙을 지키기 위해</p>
							<ul>
								<li><span class="num_ceo">첫번째,</span><span class="txt">금융소비자보호법의 취지에 부합하는 소비자보호체계를 구축하고, 상품 개발부터 판매, 사후관리에 이르기까지 전 과정에서 고객의 권익이 실질적으로 보호될 수 있도록 지속적으로 제도와 절차를 개선해 나가고 있습니다.</span></li>
								<li><span class="num_ceo">두번째,</span><span class="txt">고객의 소중한 개인정보와 금융정보를 안전하게 보호하기 위해 정보보호 관리체계를 고도화하고 전사적인 보안 인식 제고를 통해 정보보호 수준을 지속적으로 높이고 있습니다.</span></li>
								<li><span class="num_ceo">세번째,</span><span class="txt">내부통제는 형식에 그치지 않고 실제 업무 현장에서 작동될 수 있도록 제도와 프로세스를 지속적으로 점검하고 개선해 나가고 있습니다.</span></li>
							</ul>
							<p>앞으로는 모든 임직원이 책임 있는 자세로 고객의 권익을 최우선으로 고려하는 의사결정과 책임있는 금융 서비스 제공을 통해 고객과 사회로부터 신뢰받는 금융기관으로서 역할을 충실히 수행해 나가겠습니다.</p>
							<P>감사합니다.</P>
							<div class="sign">KB저축은행 대표이사 <span>곽 산 업</span></div>
						</div>
					</div>
				</div>
				<!-- SR-260129-00414 당사 모바일 웹 이용안내 > 은행 안내 > CEO 인사말 UI 변경 -->
