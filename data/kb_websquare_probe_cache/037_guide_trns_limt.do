...
<header class="fixed">
	<div class="inner-wrap">
		<h1 class="sr-only">이체한도안내</h1>
		<h2 class="page-title" id="pa2">이체한도안내</h2>
		<!-- back버튼 노출시 -->
 ...
 <body>
	<div class="wrapper" id="wrapper">
		...
		<div id="container">
			<div id="contents">
				<section class="pd-all">
					<h3 class="title-d3">1. 보안 등급별 최대 이체한도</h3>
					<table class="data-table">
						<caption>보안 등급별 최대 이체한도 정보</caption>
						<colgroup>
							<col style="width:15%">
							<col>
							<col style="width:23%">
						...
						<tbody>
							<tr>
								<th scope="row">1</th>
								<td class="align-center">PIN/지문/FaceID<br>+ OTP</td>
								<!-- 2020-04-27 수정 -->
								<td class="align-center">5억원</td>
								<td class="align-center">1억원</td>
								<!-- 2020-06-19 수정 -->
							</tr>
							<tr>
								<th scope="row" rowspan="2">2</th>
								<td class="align-center">PIN/지문/FaceID +보안카드<br>(SMS수신)</td>
								<!-- 2020-06-19 수정 -->
								<td class="align-center">7,000만원</td>
								<!-- 2020-06-19 수정 -->
								<td class="align-center">2,000만원</td>
								<!-- 2020-06-19 수정 -->
							</tr>
							<tr>
								<td class="align-center">PIN/지문/FaceID +보안카드<br>(SMS미수신)</td>
								<!-- 2020-06-19 수정 -->
								<td class="align-center">5,000만원</td>
								<!-- 2020-06-19 수정 -->
								<td class="align-center">1,000만원</td>
								<!-- 2020-06-19 수정 -->
							</tr>
							<tr>
								<th scope="row">3</th>
								<td class="align-center">PIN/지문/FaceID</td>
								<!-- 2020-04-27 수정 -->
								<td class="align-center">1,000만원</td>
								<!-- 2020-06-19 수정 -->
								<td class="align-center">1,000만원</td>
					...
					<h3 class="title-d3 mt40">2. 인증 수단별 최대 이체한도</h3>
					<!-- <p class="align-right"><small>*타행이체 한도 내</small></p> 2020-06-19 삭제 -->
					<table class="data-table mt10">
						<caption>인증 수단별 최대 이체한도 정보</caption>
						<colgroup>
							<col>
							<!-- 넓이가 넘치는것을 방지 하나 비워 둠 -->
							<col style="width:25%">
							<col style="width:25%">
						</colgroup>
						<thead>
							<tr>
								<th scope="col">구분/거래수단</th>
								<th scope="col">1일</th>
								<th scope="col">1회</th>
							</tr>
						</thead>
						...
						<tbody>
							<tr>
								<th scope="row">전화번호·카카오톡 이체<br>
									<small>PIN/지문/FaceID</small>
								</th>
								<td class="align-center">50만원</td>
								<!-- 2020-06-19 수정 -->
								<td class="align-center">50만원</td>
								<!-- 2020-06-19 수정 -->
							</tr>
							<tr>
								<th scope="row">지정계좌이체<br>
									<small>PIN/지문/FaceID</small>
								</th>
								<td class="align-center">1억원</td>
								<td class="align-center">1억원</td>
							...
							<!--<tr>
								<th scope="row">목소리이체<br>
									<small>PIN 번호(사전등록시)</small>
								</th>
								2020-06-19 수정
								<td class="align-center">50만원</td>
								<td class="align-center">50만원</td>
					...
					<!-- 2021.12.21 -->
					<h3 class="title-d3 mt40">3. 오픈뱅킹 이체한도</h3>
					<table class="data-table mt10">
						<caption>오픈뱅킹 이체한도</caption>
						<colgroup>
							<col>
							<!-- 넓이가 넘치는것을 방지 하나 비워 둠 -->
							<col style="width:25%">
						...
						<tbody>
							<tr>
								<td class="align-center">1회/1일 500만원</td>								
					...
					<button type="button" class="btn-toggle btn-link">
						<span>유의사항을 확인해 보세요</span>
					</button>
					<div class="toggle-contents">
						<ul class="list-bullet-cir">
							<li>지문/Face ID를 통한 이체 시 PIN 한도 (1일/1회 500만원) 내 포함</li>
							<li>지문/Face ID 이체한도 100만원 초과일 경우 간편비밀번호로 입력하여 이체 진행<br>(Ex. 생체인증으로 100만원 이체완료 이후 이체 시 400만원까지 간편비밀번호로 이체 진행)</li>
							<li>지문/Face ID 인증 등록화면 내 이체한도에 대한 유의사항 문구 화면 반영</li>
						</ul>
					</div>
				</div> 2020-06-19 삭제 -->
				</section>
