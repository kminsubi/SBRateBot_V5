...
<header class="fixed">
	<div class="inner-wrap">
		<h1 class="sr-only">보호금융상품 등록부</h1>
		<h2 class="page-title" id="pa2">보호금융상품 등록부</h2>
		<!-- back버튼 노출시 -->
...
<!-- header End -->
<script type="text/javascript">
/* PDF 및 파일 다운로드 폰에서만 작동 */
function downPdfFunc ( tmsFPath) {
	location.href= ctx + tmsFPath;
	//$('#frm').attr("action",ctx + tmsFPath);
	//$('#frm').submit();
}
</script>
</head>
...
<div class="wrapper" id="wrapper">
		...
		<div id="container">
			<div id="contents">
				<section class="pd-h">
					<p class="text">KB저축은행이 취급하는 금융상품 중 예금보험공사가 예금자보호법에 의하여 보호하는 금융상품의 종류는 다음과 같습니다.</p>
					<!-- 약관동의 -->

					<div class="title-area mt40">
						<h3 class="title-d2">보호금융상품목록</h3>
						<!-- 20200713 수정 - text 수정 -->
						<!-- 20220721 SR 반영 START -->
						<small>2026년 7월 1일 기준</small>
						<!-- 20220721 SR 반영 END -->
						<!-- //20200713 수정 - text 수정 -->
					</div>
					<table class="data-table">
						...
						<tbody>
							<tr>
								<td class="align-center">별단예금</td>
								<td class="align-center">별단예금</td>
								<td class="align-center">-</td>
								<td class="align-center">-</td>
							</tr>
							<tr>
								<td class="align-center">보통예금</td>
								<td class="align-center">kiwi입출금통장</td>
								<td class="align-center">2020.07.06</td>
								<td class="align-center">-</td>
							</tr>
							<tr>
								<td class="align-center">보통예금</td>
								<td class="align-center">kiwi팡팡통장</td>
								<td class="align-center">2023.05.24</td>
								<td class="align-center">-</td>
							</tr>
							<tr>
								<td class="align-center">보통예금</td>
								<td class="align-center">국민연금안심통장</td>
								<td class="align-center">2013.02.21</td>
								<td class="align-center">-</td>
							</tr>
							<!-- 20200713 수정 - tr 수정 -->
							<tr>
								<td class="align-center">보통예금</td>
								<td class="align-center">기업자유예금</td>
								<td class="align-center">2023.09.18</td>
								<td class="align-center">-</td>
							</tr>
							<tr>
								<td class="align-center">보통예금</td>
							...
							<tr>
								<td class="align-center">보통예금</td>
								<td class="align-center">저축예금</td>
								<td class="align-center">-</td>
								<td class="align-center">-</td>
							</tr>
							<tr>
								<td class="align-center" rowspan="2">정기예금</td>
								<td class="align-center">ISA정기예금</td>
								<td class="align-center">2016.03.31</td>
								<td class="align-center">-</td>
							</tr>
							<tr>
								<td class="align-center" colspan="3">* ISA 편입 상품</td>
							</tr>
							<tr>
								<td class="align-center">정기예금</td>
								<td class="align-center">KB e-plus 정기예금</td>
								<td class="align-center">2012.01.13</td>
								<td class="align-center">-</td>
							</tr>
							<tr>
								<td class="align-center">정기예금</td>
								<td class="align-center">KB369회전식정기예금</td>
								<td class="align-center">2025.11.17</td>
								<td class="align-center">-</td>
							</tr>
							<tr>
								<td class="align-center">정기예금</td>
								<td class="align-center">KB369회전식정기예금(대면)</td>
								<td class="align-center">2025.11.17</td>
								<td class="align-center">-</td>
							</tr>
							<tr>
							...
							<tr>
								<td class="align-center" rowspan="2">정기예금</td>
								<td class="align-center">퇴직연금 정기예금(DC형, IRP형)</td>
								<td class="align-center">2018.11.01</td>
								<td class="align-center">-</td>
							</tr>
							<tr>
								<td class="align-center" colspan="3">* 퇴직연금 편입 상품</td>
							</tr>
							<tr>
								<td class="align-center">정기예금</td>
								<td class="align-center">플러스회전식정기예금</td>
								<td class="align-center">2024.11.14</td>
								<td class="align-center">-</td>
							</tr>
							<tr>
								<td class="align-center">정기예금</td>
								<td class="align-center">플러스회전식정기예금(대면)</td>
								<td class="align-center">2024.11.14</td>
								<td class="align-center">-</td>
							</tr>
							<tr>
								<td class="align-center" rowspan="2">정기적금</td>
								<td class="align-center">ISA정기적금</td>
								<td class="align-center">2016.05.23</td>
								<td class="align-center">-</td>
							</tr>
							<tr>
								<td class="align-center" colspan="3">* ISA 편입 상품</td>
							...
							<tr>
								<td class="align-center">정기적금</td>
								<td class="align-center">KB일반e-plus정기적금</td>
								<td class="align-center">2016.01.11</td>
								<td class="align-center">-</td>
							</tr>
							<tr>
								<td class="align-center">정기적금</td>
								<td class="align-center">KB일반정기적금</td>
								<td class="align-center">2016.01.11</td>
								<td class="align-center">-</td>
							</tr>
							<tr>
								<td class="align-center">정기적금</td>
								<td class="align-center">KB착한e-plus정기적금</td>
								<td class="align-center">2016.01.11</td>
								<td class="align-center">-</td>
							</tr>
							<tr>
								<td class="align-center">정기적금</td>
								<td class="align-center">KB착한누리적금</td>
								<td class="align-center">2018.05.18</td>
								<td class="align-center">-</td>
							</tr>
							<!-- //20200713 추가 - tr 추가 -->
							<tr>
								<td class="align-center">정기적금</td>
								<td class="align-center">KB착한정기적금</td>
								<td class="align-center">2016.01.11</td>
								<td class="align-center">-</td>
							</tr>
							<tr>
								<td class="align-center">정기적금</td>
								<td class="align-center">첫kiwi적금</td>
								<td class="align-center">2024.05.13</td>
								<td class="align-center">-</td>
							</tr>
							<tr>
								<td class="align-center">자유적립예금</td>
								<td class="align-center">자유적립예금</td>
								<td class="align-center">-</td>
								<td class="align-center">-</td>
							</tr>
							<tr>
								<td class="align-center">정기예금</td>
								<td class="align-center">세테크정기예금</td>
								<td class="align-center">-</td>
								<td class="align-center">2012.01.16</td>
							</tr>
							<tr>
								<td class="align-center">장기주택 마련저축</td>
								<td class="align-center">장기주택 마련저축</td>
								<td class="align-center">-</td>
								<td class="align-center">2013.01.01</td>
							</tr>
							<tr>
								<td rowspan="2" class="align-center">수입부금</td>
								<td class="align-center">예한솔 신용부금</td>
								<td class="align-center">-</td>
								<td class="align-center">2014.01.13</td>
							</tr>
							<tr>
								<td colspan="2" class="align-center">
									<p class="sub-txt">* 예한솔저축은행 합병으로 인한 추가상품</p>
								</td>
							</tr>
							<tr>
								<td class="align-center" rowspan="2">정기예금</td>
								<td class="align-center">예한솔정기예금</td>
								<td class="align-center">-</td>
								<td class="align-center">2014.01.13</td>
							</tr>
							<tr>
							...
							<tr>
								<td rowspan="2" class="align-center">자유적립예금</td>
								<td class="align-center">예한솔 자유적립예금</td>
								<td class="align-center">-</td>
								<td class="align-center">2014.01.13</td>
							</tr>
							<tr>
							...
							<tr>
								<td class="align-center" rowspan="2">정기적금</td>
								<td class="align-center">예한솔정기적금</td>
								<td class="align-center">-</td>
								<td class="align-center">2014.01.13</td>
							</tr>
							<tr>
							...
							<tr>
								<td class="align-center">정기예금</td>
								<td class="align-center">KB스마트패키지 정기예금</td>
								<td class="align-center">2013.08.28</td>
								<td class="align-center">2015.06.30</td>
							</tr>
							<tr>
								<td class="align-center">정기적금</td>
								<td class="align-center">KB스마트패키지 정기적금</td>
								<td class="align-center">2013.08.28</td>
								<td class="align-center">2015.06.30</td>
							</tr>
							<tr>
								<td class="align-center">재형저축</td>
								<td class="align-center">KB저축은행 재형저축</td>
								<td class="align-center">2013.03.18</td>
								<td class="align-center">2015.12.31</td>
							</tr>
							<tr>
								<td class="align-center">정기적금</td>
								<td class="align-center">정기적금</td>
								<td class="align-center">-</td>
								<td class="align-center">2016.01.08</td>
							</tr>
							<tr>
								<td class="align-center" rowspan="2">보통예금</td>
								<td class="align-center">KB착한 모바일통장</td>
								<td class="align-center">2016.10.13</td>
								<td class="align-center">2020.07.06</td>
							</tr>
							<tr>
								<td class="align-center" colspan="3">* kiwi입출금통장으로 개정</td>
							</tr>
							<tr>
								<td class="align-center">보통예금</td>
								<td class="align-center">kiwi입출금(리브메이트)통장</td>
								<td class="align-center">2020.08.10</td>
								<td class="align-center">2021.09.24</td>
							</tr>
							<tr>
								<td class="align-center">정기적금</td>
								<td class="align-center">골드kiwi적금</td>
								<td class="align-center">2021.05.06</td>
								<td class="align-center">2022.07.27</td>
							</tr>
							<tr>
								<td class="align-center">정기예금</td>
								<td class="align-center">KB회전식정기예금</td>
								<td class="align-center">2023.04.03</td>
								<td class="align-center">2024.11.14</td>
							</tr>
							<tr>
								<td class="align-center">정기예금</td>
								<td class="align-center">kiwi회전식정기예금</td>
								<td class="align-center">2023.04.03</td>
								<td class="align-center">2024.11.14</td>
							</tr>
							<tr>
								<td class="align-center">정기적금</td>
								<td class="align-center">kiwi청년적금</td>
								<td class="align-center">2024.05.13</td>
								<td class="align-center">2025.01.01</td>
							</tr>
							<tr>
								<td class="align-center">보통예금</td>
								<td class="align-center">KB팡팡mini통장</td>
								<td class="align-center">2025.09.08</td>
								<td class="align-center">2025.12.29</td>
							</tr>
							<tr>
								<td class="align-center">정기적금</td>
								<td class="align-center">팡팡적금</td>
								<td class="align-center">2025.07.01</td>
								<td class="align-center">2026.01.29</td>
							</tr>
							<tr>
								<td class="align-center">정기적금</td>
								<td class="align-center">KB꿀적금</td>
								<td class="align-center">2019.04.15</td>
								<td class="align-center">2026.03.18</td>
							</tr>
							<tr>
								<td class="align-center">정기적금</td>
								<td class="align-center">플러스kiwi적금</td>
								<td class="align-center">2023.05.15</td>
								<td class="align-center">2026.06.30</td>
							</tr>
						</tbody>
					</table>
					<!-- //data-table -->
					...
					<!-- 20-05-21 컨텐츠추가 -->
					<div class="title-area line2 mt40">
						<h3 class="title-d2">다른 부보금융회사
							<span>보호금융상품 판매 목록</span>
						</h3>
						<!-- 20200713 수정 - text 수정 -->
						<!-- 20220721 SR 반영 START -->
						<small>2026년 7월 1일 기준</small>
					...
					<div class="panel-list protection-pdf">
						<div class="panel">
							<div class="dl-contents justify">
								...
								<dl>
									<dt>상품유형<sup>주1)</sup></dt>
									<dd>-</dd>
								</dl>
								<dl>
									<dt>상품종류<sup>주2)</sup></dt>
									<dd>해당사항없음</dd>
								</dl>
								<dl>
									<dt>금융상품명</dt>
					...
					<ul class="list-bullet-cir mt20">
						<li><sup>주1)</sup> 금소법에 따른 금융상품 유형(예금성, 투자성, 보장성) </li>
						<li><sup>주2)</sup> 보험, 퇴직연금, 개인종합자산관리계좌(ISA) 등 </li>
					</ul>

					<div class="ui-toggle notice-toggle">
						<button type="button" class="btn-toggle btn-link">
							<span>예금자보호제도 안내</span>
						</button>
						<!-- toggle 영역 -->
						<div class="toggle-contents">
							<p>
								<small>예금자보호제도에 관한 자세한 내용은 영업점에 비치된 예금자보호 안내책자 등을 참고하시거나 예금보험공사 (<i class="ico-tel"></i>1588-0037, www.kdic.or.kr)로 문의하시기 바랍니다. </small>
							</p>
							<!-- 2020-04-01 오타 수정 -->
							<ul class="list-bullet-cir mt20">
								<!-- 20200713 수정 - li 내용 수정 -->
								<li>정부, 지방자치단체, 한국은행, 금융감독원, 예금보험공사, 부보금융회사가 가입한 금융상품은 보호되지 않습니다. </li>
								<!-- //20200713 수정 - li 내용 수정 -->
								<li>퇴직연금 편입 상품은 확정급여형 퇴직연금(DB)으로 운용 시 보호되지 않습니다. </li>
							</ul>
						</div>
					</div>
					<!-- //ui-toggle //notice-toggle -->

					<div class="page-btns fixed">
						<a href="/mobweb/images_kiwi/tms/CUS130010M/CUS130010M.pdf" download>
							<button type="button" class="btn-lg-primary protection-pdf-down" id="btnDown">
								<span>보호금융상품등록부 상세 PDF</span>
							</button>
						</a>
					</div>
				</section>
