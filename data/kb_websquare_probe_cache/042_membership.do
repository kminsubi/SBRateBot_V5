...
<header class="fixed">
	<div class="inner-wrap">
		<h1 class="sr-only">kiwi 멤버십 안내</h1>
		<h2 class="page-title" id="pa2">kiwi 멤버십 안내</h2>
		<!-- back버튼 노출시 -->
...
<body>
	...
	<div class="wrapper" id="wrapper">
		<!-- container -->
		<div id="container">
			<div id="contents" class="benefit-page">
				<div class="detail-top kiwi-membership-top">
                    <div class="prd-info">
                        <span class="txt-tit">kiwi 멤버십</span>
                        <span class="txt-desc">지금 가입하여 kiwi 멤버십의<br>혜택과 서비스를 누려보세요!</span>
                    </div>
                    <div class="img-area"><img src="/mobweb/images_kiwi/ncontents/img_membership.png" alt=""></div>
                </div>
				<section class="pd-h kiwi-membership-cont">
					<div class="dv-group">
						<p class="title-d3">제공 혜택 및 서비스</p>
						<ul class="list-bullet-decimal type4">
							<li>
								<!-- SR-260601-02038 [웹] kiwi멤버십 가입 프로세스 개선 - 문구 변경 -->
								<span>1</span><b>생일(주민등록번호 기준) 축하 모바일쿠폰 지급</b></li>
							<li>
								<span>2</span>KB저축은행 이벤트 및 프로모션 안내</li>
							<li>
								<span>3</span>여신 및 수신상품 이벤트 시 우선 안내 및 일정 비율 우선권 제공</li>
							<li>
								<span>4</span>대환대출 안내</li>
						</ul>
					</div>
					<div class="dv-group tx-gray">
						<p class="title-d4">가입·탈퇴 유의사항</p>
						<!-- 25.10.02  문구수정-->
						<ul class="list-bullet-dot">
							<li>kiwi 멤버십은 kiwi 멤버십 특별 약관과 개인정보 수집·이용 동의서(kiwi 멤버십 가입용)을 모두 동의해야 가입이 가능합니다.</li>
							<li>kiwi멤버십 가입 및 광고성 정보 수신 동의 수단 변경은 KB저축은행 앱에서 가능합니다.</li>
							<li>kiwi 멤버십 탈퇴는 KB저축은행 앱 또는 고객센터(<span class="num">1899-0900</span>)를 통해 가능하며, 모바일 뱅킹 해지 시에도 혜택 및 서비스를 제공받을 수 있습니다.</li>	
						</ul>
					</div>
					<div class="dv-group tx-gray">
						<p class="title-d4">제공 혜택 유의사항</p>
						<!-- 25.10.02  문구수정-->
						<ul class="list-bullet-dot">
							<!-- SR-260601-02038 [웹] kiwi멤버십 가입 프로세스 개선 - 문구 변경 -->
							<li>생일 축하 모바일 쿠폰은 생일 당일 KB저축은행 '내쿠폰함'에 발급되며, 시스템 상황에 따라 혜택 발급이 지연될 수 있습니다. (경로 : KB저축은행 앱 > 오른쪽 상단 메뉴(三) > 혜택 > 내쿠폰함)</li>
							<li>kiwi 멤버십 탈퇴 및 마케팅 수신 설정 철회, KB저축은행 체크카드(KB국민kiwibank 체크카드, 팡팡KB체크카드) 해지 시 생일 축하 모바일 쿠폰이 제공되지 않습니다.</li>
							<!-- SR-260601-02038 [웹] kiwi멤버십 가입 프로세스 개선 - 문구 변경 -->
							<li>2021년부터 생일 축하 모바일 쿠폰 지급은 금액과 관계없이 체크카드 실적이 있는 경우에 한하여 제공합니다.
								<span class="button-wrap rt"><button type="button" class="btn-link" onclick="UI.layerPop('#couponInfoLayer');"><span>쿠폰제공대상 자세히보기</span></button></span>
							</li>
							<li class="rt-tx">
								해당 이벤트는 당사의 상황에 따라 변경될 수 있습니다.
							</li>
						</ul>
					</div>
				</section>
	...
	<section class="layer bottom-sheet" id="couponInfoLayer">
        <div class="layer-header">
            <h1 class="layer-title type2">kiwi 멤버십<br>생일축하 모바일쿠폰 지급 기준</h1>
            <button type="button" class="layer-close cancel">
                <span class="sr-only">레이어 닫기</span>
            </button>
        </div>
        <div class="layer-contents">
			<div class="bg-gray-box round-8">
				<ul class="list-bullet-dot">
					<!-- 25.10.02 문구 삭제 -->
					<li>2021년 생일축하 모바일쿠폰은 생일 7일전 기준 최근 180일*간 금액과 관계없이 KB저축은행 
						체크카드(KB국민kiwibank 체크카드, 팡팡KB체크카드) 실적이 있는 경우에 제공됩니다. <br>
						(거래승인 후 취소건은 제외)
						<span class="mt28">*예시) 1월 1일 생일인 경우 실적 인정 기간 : <br>2020.06.28~2020.12.25</span>
					</li>
				</ul>
			</div>
        </div>
        <div class="layer-btns">
            <button type="button" class="btn-lg-primary cancel" onclick="UI.layerPopClose('#couponInfoLayer');">확인</button>
    	</div>
	</section>
</body>
</html>