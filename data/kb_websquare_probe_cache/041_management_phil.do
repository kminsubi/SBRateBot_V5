...
<header class="fixed">
	<div class="inner-wrap">
		<h1 class="sr-only">경영이념</h1>
		<h2 class="page-title" id="pa2">경영이념</h2>
		<!-- back버튼 노출시 -->
	...
	<div class="wrapper" id="wrapper">
		...
		<div id="container">
			<div id="contents">
				<section class="pd-h">
					<div class="light">
						<p class="head-copy normal"><em>KB저축은행은</em></p>
						<p class="text mt12">KB금융그룹의 가족으로 그룹의 비전에<br>연계하여 미션 · 비전 · 행동원칙등 가치체계를<br>구축하였으며 이를 실천하고 있습니다.</p>
						<p class="text-gray mt8">고객의 성원을 바탕으로 최고의 금융기관으로<br>도약할 것을 약속 드립니다.</p>
					</div>
					<div class="img-wrap mt20">
						<img src="/mobweb/images_kiwi/ncontents/illust_mng_visual.svg" alt="비전, 미션, 행동원칙">
					</div>
					<div class="pd-h">
						<div class="core">
							<h3 class="title-d1 mt36"><em>미션(Mission)</em></h3>
							<p class="text-16 mt12">세상을 바꾸는 금융</p>
							<p class="text-gray mt8 light">고객의 행복과 더 나은 세상을 만들어 갑니다.</p>
							<h3 class="title-d1 mt36"><em>비전(Vision)</em></h3>
							<p class="text-16 mt12">최고의 인재와 담대한 혁신으로<br>가장 신뢰받는 착한 금융 파트너</p>
							<h3 class="title-d1 mt36 "><em>핵심가치(Core Value)</em></h3>
						</div>
					</div>
					<div class="img-wrap mt20">
						<img src="/mobweb/images_kiwi/ncontents/illust_mng_core.svg" alt="고객중심 - 혁신주도, 동반성장, 신뢰정직, 전문성">
					</div>
				</section>
			</div>
		</div>
